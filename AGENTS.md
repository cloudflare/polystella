...
| Modify the EmDash plugin                               | `packages/emdash/src/*`                                                                          | Provider/locale/model bounds stay server-owned; collection policy is administrator-owned; Git catalogs stay canonical | [`EMDASH_PLUGIN_IMPLEMENTATION_PLAN.md`](./EMDASH_PLUGIN_IMPLEMENTATION_PLAN.md)                                                                    |
