...
const peekNoTranslate = (ast: Root): boolean => markdownAdapter.peekNoTranslate(ast);
const selectTranslatableFrontmatter = (ast: Root, options: ExtractOptions): Record<string, unknown> =>
  markdownAdapter.selectedValuesForHash(ast, "", {
    sourcePath: options.sourcePath,
    translatableKeys: options.frontmatter,
