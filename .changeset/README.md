...
- **Which packages are affected?** Select every package changed by the PR:
  ...
  `@cloudflare/polystella-providers`, `@cloudflare/polystella-cli`,
  `@cloudflare/polystella-emdash`, `@cloudflare/polystella`, and/or
  `@cloudflare/polystella-astro`. Astro and the compatibility package form a
  fixed group; core, adapters, providers, CLI, and EmDash are versioned
