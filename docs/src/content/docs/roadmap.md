...
Items marked "planned" have a concrete design but no firm
commitment on when they ship. If you want a planned item
prioritised, file an issue on the GitHub repo with the use case.
