...
| EmDash    | `@cloudflare/polystella-emdash/client`            | Ambient types for the `polystella:catalog` virtual module.                                                | `/// <reference types="@cloudflare/polystella-emdash/client" />`                               |
